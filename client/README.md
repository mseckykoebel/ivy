...
Ivy's client is the app that users see and interact with. **Ivy's currently in pre-release. This means not all v1.0 features are available, or stable. Ivy 1.0 is slated for release by ~October 15th, 2022.**

## Roadmap and feature list

### Ivy v1.0 - October 15th, 2022:
